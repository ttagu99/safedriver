...
trn_df = pd.read_csv(root + "/input/train/train.csv", index_col=0)
sub_df = pd.read_csv(root+"/input/test/test.csv", index_col=0)
...
sub_df[["target"]].to_csv(root + "UpSample_submission.csv", index=True, float_format="%.9f")